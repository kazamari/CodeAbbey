...
Answers should be integer too and you are to write them in line, separating with spaces and enclosing each pair in
...
print(*[linear(*map(int, line.rstrip().split())) for i, line in enumerate(sys.stdin) if i > 0 ])
