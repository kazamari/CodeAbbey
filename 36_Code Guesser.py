'''
Andrew and Peter play the code-guessing game. Andrew chooses a secret number consisting of 3 digits. Peter tries
to guess it, proposing several values, one by one.
...
inp = [['402', 0], ['390', 0], ['816', 2], ['848', 2], ['777', 0], ['815', 1]]

n = len(inp[0][0])

for x, y in [[x, y] for x, y in inp if y > 0]:
    print(list(x))
